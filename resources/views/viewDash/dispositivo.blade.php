                        ...
                        <div class="modal-content bg-dark text-white border-0 shadow-lg rounded-4">
                            ...
                            <div class="modal-body px-5 pb-5">
                                <form method="POST" action="{{ route('devices.store') }}" id="formAdicionarDispositivo">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <label for="nome" class="form-label fw-medium">Nome do dispositivo</label>
                                            <input type="text" name="nome" id="nome" class="form-control bg-secondary text-white border-0" placeholder="ex: Lâmpada Sala" required autofocus>
                                        ...
                                        <div class="col-12">
                                            <label for="consumo_base" class="form-label fw-medium">Consumo base (Watts)</label>
                                            <input type="number" name="consumo_base" id="consumo_base" class="form-control bg-secondary text-white border-0" placeholder="ex: 12" min="1" required>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="ativo">Ativar dispositivo imediatamente</label>
                                            </div>
                                        </div>
                                    </div>
